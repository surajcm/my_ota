...
public class AirOffersRequestBuilder {
    public IATAOfferPriceRQ mockIATAOfferPriceRQ() {
        IATAOfferPriceRQ iataOfferPriceRQ = new IATAOfferPriceRQ();
        iataOfferPriceRQ.setMessageDoc(mockMessageDoc());
        iataOfferPriceRQ.setParty(party());
        iataOfferPriceRQ.setPOS(pos());
        iataOfferPriceRQ.setRequest(request());
    ...
    private MessageDocType mockMessageDoc() {
